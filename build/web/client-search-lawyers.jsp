...
<head>
    ...
    <style>
        ...
        .filter-item label { display: block; color: #1f2937; font-weight: 500; margin-bottom: 0.5rem; font-size: 0.9rem; }
        .filter-control {
            width: 100%;
            padding: 0.75rem;
        ...
        .btn-filter { background: #2563eb; color: white; flex: 1; }
        .btn-filter:hover { background: #1e40af; }
        .btn-reset { background: #f9fafb; color: #1f2937; }
        .lawyers-grid {
            display: grid;
        ...
        .lawyer-card:hover { transform: translateY(-5px); box-shadow: 0 8px 20px rgba(0,0,0,0.1); border-color: #2563eb; }
        .lawyer-header { display: flex; gap: 1rem; margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 2px solid #f9fafb; }
        .lawyer-avatar {
        ...
        .lawyer-name { font-size: 1.2rem; font-weight: 700; color: #1f2937; margin-bottom: 0.25rem; }
        .lawyer-specialization { color: #2563eb; font-weight: 600; font-size: 0.9rem; margin-bottom: 0.5rem; }
        ...
        .detail-item i { color: #2563eb; width: 18px; }
        ...
        .btn-contact:hover { background: #1e40af; }
...
<body>
            ...
            <div class="filter-grid">
                ...
                <div class="filter-item">
                    ...
                    <select id="filterPrice" class="filter-control">
                        ...
                        <option value="Rs.500-1000/hour">Rs.500-1000/hour</option>
                        <option value="Rs.1000-2000/hour">Rs.1000-2000/hour</option>
                        <option value="Rs.2000-5000/hour">Rs.2000-5000/hour</option>
                        <option value="Rs.5000+/hour">Rs.5000+/hour</option>
                    </select>
                </div>
                <div class="filter-item">
    ...
    <div id="emptyState" style="display: none; text-align: center; padding: 3rem;">
        ...
        <h3 style="margin-top: 1rem; color: #1f2937;">No Lawyers Found</h3>
                        ...
                        card.innerHTML = 
                            '<div class="lawyer-header">' +
                                ...
                                '<div style="flex: 1;">' +
                                    ...
                                    '<div class="lawyer-rating">Rating: 4.5/5</div>' +
                                '</div>' +
                            '</div>' +
                            '<div>' +
                                ...
                                '<div class="detail-item"><i class="fas fa-money-bill"></i><span>' + lawyer.hourlyRate + '</span></div>' +
